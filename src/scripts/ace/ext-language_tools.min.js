define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/autocomplete/text_completer", "ace/editor"], function (e, t, n) {
  ...
  }), define("ace/snippets", ["require", "exports", "module", "ace/lib/lang", "ace/range", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom"], function (e, t, n) {
    var r = e("./lib/lang"),
      i = e("./range").Range,
    ...
    (function () {
      this.getTokenizer = function () {
        ...
        for (var c = 0; c < o.length; c++) {
          ...
          var v = u[p],
            m = typeof v.value == "string" ? [v.value] : l(v.value);
      ...
      this.attach = function (e) {
        ...
        e.forEach(function (e) {
          for (var n = e.length; n--;) {
            var r = e[n],
              s = i.fromPoints(r.start, r.end || r.start);
    ...
    var r = e("../edit_session").EditSession,
      ...
      c = function (e) {
        ...
        return d.$tokenizeRow = function (e) {
          ...
          var i = -1,
            s, o;
          for (var e = 0; e < t.caption.length; e++) o = t.caption[e], s = t.matchMask & 1 << e ? 1 : 0, i !== s ? (r.push({
