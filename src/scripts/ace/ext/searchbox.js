define('ace/ext/searchbox', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/lang', 'ace/lib/event', 'ace/keyboard/hash_handler', 'ace/lib/keys'], (e, t, n) => {
  ...
  (function () {
    this.setEditor = function (e) {
      ...
      this.$initElements(e);
      const t = this;
      s.addListener(e, 'mousedown', (e) => {
        setTimeout(() => {
          t.activeInput.focus();
        }, 0), s.stopPropagation(e);
      }), s.addListener(e, 'click', (e) => {
      ...
      }), s.addCommandKeyListener(e, (e, n, r) => {
        const i = a.keyCodeToString(r);
        const o = t.$searchBarKb.findKeyCommand(n, i);
      ...
      'Ctrl-f|Command-f|Ctrl-H|Command-Option-F': function (e) {
        const t = e.isReplace = !e.isReplace;
      ...
      const n = this.editor.find(this.searchInput.value, {
        skipCurrent: e,
        backwards: t,
        wrap: !0,
      ...
      const i = !n && this.searchInput.value;
