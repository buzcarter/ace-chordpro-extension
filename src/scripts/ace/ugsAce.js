...
<div class="aceHelp">
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td class="shortKeys">
          <code class="key">CTRL</code> + <code class="key">F</code>
        </td>
        <td>Find</td>
      </tr>
      <tr>
        <td class="shortKeys">
          <code class="key">CTRL</code> + <code class="key">H</code>
        </td>
        <td>Search &amp; Replace</td>
      </tr>
      <tr>
        <td class="shortKeys">
          <code class="key">ESCAPE</code>
        </td>
        <td>Close Find or Chord window</td>
      </tr>
      <tr>
        <td class="shortKeys">
          <code class="key">CTRL</code> + <code class="key">SPACEBAR</code>
        </td>
        <td>
          Lists your song's chords. Use <code class="key">DOWNARROW</code> &amp; <code class="key">UPARROW</code> to
          choose one, or type a few letters of the chord name to narrow suggestions. Press <code class="key">ENTER</code> to add it to your song.
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <p>
    ...
    to replace this. If more than one placeholder is available pressing <code class="key">TAB</code> again will cycle
    through them.
  </p>
</div>`;
